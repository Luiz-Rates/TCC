...
<body class="font-sans antialiased bg-slate-950 text-slate-100">
    <div class="flex min-h-screen flex-col bg-gradient-to-b from-slate-950 via-slate-950/95 to-slate-900/90">
    ...
    {{-- Scripts adicionais (ex: jQuery, Select2, inicialização de plugins) --}}
    @yield('scripts')
</body>
</html>
